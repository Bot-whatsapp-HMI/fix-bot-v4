...
/*============== STAFF ==============*/
global.owner = [
  ['6285727901873', '𝕏𝕥𝕣𝕚𝕡', true],
  ['6285742257119', 'ℤ𝕒𝕟𝕤', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.wm = '                「 𝐶𝐴𝑀𝐸𝐿 𝐵𝑂𝑇 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝐶𝐴𝑀𝐸𝐿 𝐵𝑂𝑇 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ 𝐶𝐴𝑀𝐸𝐿 𝐵𝑂𝑇 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By 𝑋𝑇𝑅𝐼𝑃`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 𝑋𝑇𝑅𝐼𝑃  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = '𝐶𝐴𝑀𝐸𝐿 𝐵𝑂𝑇'
global.stickauth = `By ©𝕏𝕋ℝ𝕀ℙ`
